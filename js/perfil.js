...
const AXES48=[
 ...
 // ---- afetivo ----
 ['Emotividade–Reserva afetiva','afetivo','emot',['asc','ruler','moon','venus']],
 ['Vinculação–Desapego','afetivo','bond',['asc','ruler','h7ruler','moon','venus','modes']],
 ['Expressividade afetiva–Reticência','afetivo','express',['asc','ruler','rulerHouse','moon','mercury','h1']],
 ['Sensibilidade–Blindagem','afetivo','sensi',['asc','ruler','moon','venus','h1']],
 ['Confiança–Vigilância','afetivo','trust',['asc','ruler','sun','moon','mars']],
 ['Hedonismo–Ascetismo','afetivo','hedon',['asc','ruler','venus','jupiter','saturn']],
 ['Generosidade–Economia','afetivo','giving',['asc','ruler','jupiter','venus','h2ruler']],
 ['Idealismo–Pragmatismo','afetivo','ideal',['asc','ruler','jupiter','moon','saturn','elems']],
 // ---- cognitivo ----
 ['Abstração–Concretude','cognitivo','abstr',['asc','ruler','elems','mercury','h1','cadent','h12']],
 ['Análise–Síntese','cognitivo','analys',['asc','ruler','mercury','jupiter','saturn','moon','h3ruler','h9ruler']],
 ['Concentração–Dispersão','cognitivo','concen',['asc','ruler','mercury','saturn','jupiter','moon','sun']],
 ['Sequencialidade–Apreensão global','cognitivo','analys',['asc','ruler','mercury','saturn','modes']],
 ['Exame crítico–Receptividade simbólica','cognitivo','analys',['asc','mercury','saturn','moon','h9ruler']],
 ['Retenção–Improvisação','cognitivo','persist',['asc','ruler','saturn','mercury','moon','modes']],
 ['Flexibilidade cognitiva–Dogmatismo','cognitivo','speed',['asc','ruler','mercury','jupiter','saturn','modes']],
 ['Imaginação simbólica–Literalidade','cognitivo','ideal',['asc','ruler','moon','mercury','h12','elems']],
 ['Transparência–Reserva estratégica','cognitivo','transp',['asc','ruler','mercury','jupiter','saturn','h12']],
 // ---- volitivo ----
 ['Ordem–Espontaneidade','volitivo','order',['asc','ruler','saturn','mercury','modes']],
 ['Disciplina–Inconstância','volitivo','order',['asc','ruler','saturn','moon','lord','modes']],
 ['Rigidez–Maleabilidade','volitivo','persist',['asc','ruler','saturn','mars','modes']],
 ['Estabilidade–Mudança','volitivo','persist',['asc','ruler','saturn','moon','elems','modes']],
 ['Planejamento–Ação emergente','volitivo','order',['asc','ruler','saturn','mercury','mars']],
 ['Controle–Entrega','volitivo','selfctl',['asc','ruler','saturn','sun','moon']],
 ['Execução–Procrastinação','volitivo','act',['asc','ruler','mars','saturn','lord']],
 ['Perfeccionismo–Suficiência','volitivo','order',['asc','ruler','mercury','saturn','h6ruler']],
 ['Autocontrole–Impulsividade','volitivo','selfctl',['asc','ruler','saturn','mars','moon']],
 ['Ambição–Contentamento','volitivo','ambit',['asc','ruler','sun','mars','h10ruler','saturn']],
 ['Expansão–Conservação','volitivo','expand',['asc','ruler','jupiter','saturn','modes']],
 // ---- social ----
 ['Extroversão–Introversão','social','extro',['asc','ruler','rulerHouse','lord','h1','cadent']],
 ['Dominação–Acomodação','social','domin',['asc','ruler','rulerHouse','sun','mars']],
 ['Sociabilidade–Seletividade','social','social',['asc','ruler','jupiter','h1','lord']],
 ['Assertividade–Conciliação','social','assert',['asc','ruler','mars','venus','sun']],
 ['Competição–Cooperação','social','compet',['asc','ruler','mars','venus','h7ruler']],
 ['Autonomia–Dependência','social','auton',['asc','ruler','sun','mars','h7ruler','moon']],
 ['Coesão identitária–Multiplicidade','social','cohes',['asc','ruler','sun','mercury','modes']],
 // ---- comportamental ----
 ['Otimismo–Pessimismo','comportamental','optim',['asc','ruler','jupiter','saturn','moon']],
 ['Honra–Utilidade','comportamental','honor',['asc','ruler','sun','jupiter','mercury']],
 ['Tradição–Experimentação','comportamental','tradi',['asc','ruler','saturn','jupiter','modes']]];
